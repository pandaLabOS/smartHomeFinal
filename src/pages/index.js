      ...
      <main className={styles.main}>
        ...
        <section className={styles.devicesControlPanel}>
          ...
          <div className={styles.devicesControlPanelTopRow}>
            <DeviceButton property = {
              <div className={deviceControl.newButton}>
                <div className={deviceControl.lightBulbIcon} id="hallwayLightButton" sensor_name='hallway_light' eid='name=hallway' change={hallway}>
                  Hallway Lights
                </div>
              </div>
            } />
            ...
            <DeviceButton property = {
              <div className={deviceControl.newButton}>
                <div className={deviceControl.lightBulbIcon} id="livingRoomButton" sensor_name='livingroom_light' eid='name=living' change={living}>
                  Bathroom Lights
                </div>
              </div>
            } />
            ...
            <DeviceButton property = {
              <div className={deviceControl.newButton}>
                <div className={deviceControl.lightBulbIcon} id='diningRoomButton' sensor_name="diningroom_light" eid='name=dining' change={dining}>
                  Dining Room Lights
                </div>
              </div>
            } />
            ...
            <IRButton property = {
              <div className={deviceControl.newButton}>
                <div className={deviceControl.acIcon} id="airConditionerButton" sensor_name="ac">
                  Air Conditioner
                </div>
              </div>
            }/>
            ...
            <IRButton property = {
              <div className={deviceControl.newButton}>
                <div className={deviceControl.tvIcon} id="tvButton" sensor_name="tv" eid='name=tv' change={tv}>
                  Television
                </div>
              </div>
            } />
