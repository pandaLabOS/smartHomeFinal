...
while True:
  ...
  #line rule A -> B from left to right 
  linexpos = 255
  cv.line(img, (linexpos, 0), (linexpos, cols), (255, 0, 0), 5)
  ...
  for detection in cvOut[0,0,:,:]:
    ...
    if score > 0.5:    #acceptance predicted score
      ...
      if classes[idx] == 'car' or classes[idx] == 'person' or classes[idx] == 'cat':          
        ...
        #center dot 
        dotX = ((right - left)/2)+ left
        dotY = ((bottom - top)/2)+ top
        ...
        if dotX > linexpos:
          ...
          cv.circle(img, (int(dotX), int(dotY)), radius = 2, color=(255, 0, 0), thickness= 2)
